...
T_real_df = pd.read_csv('Transient Periodic File/data/temperature/Temperature_Boundary_External_9_80_1200.csv')
...
for deviation in deviation_values:
    ...
    filename = f'Transient Periodic File/data/random_values/random_values_{Nt}x{num_sensors}.npy'
...
final_df.to_csv(f'Transient Periodic File/data/temperature pertubed/random_values_{Nt}x{num_sensors}.csv', index=False)