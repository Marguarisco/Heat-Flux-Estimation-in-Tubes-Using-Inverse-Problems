...
def run_experiment(radial_size, angular_size, experimental_time, dt_real):
    import pandas as pd
    ...
    '''A = 100
    B = [50, 20, 10, 40, 50, 80, 70, 40]
    C = [40, 30, 20, 10, 50, 60, 70, 80]
    ...
    q = np.zeros(angular_size, dtype=np.float64)
    ...
    csv_filename = f'Transient Periodic File/data/temperature/Temperature_Boundary_External_{radial_size}_{angular_size}_{experimental_time}.csv'
